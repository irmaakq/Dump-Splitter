    ...
    <div className={`fixed inset-0 z-[90] bg-black/90 backdrop-blur-md flex items-center justify-center p-4 transition-all duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <div className={`bg-[#0f0f0f] border border-white/10 rounded-3xl max-w-3xl w-full p-8 relative shadow-2xl overflow-y-auto max-h-[85vh] custom-scrollbar transform transition-all duration-300 ${isVisible ? 'scale-100 translate-y-0' : 'scale-95 translate-y-4'}`}>
        ...
        <div className="block md:columns-2 gap-6">
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><FileQuestion size={14} className="text-yellow-400" /> Video yükleyebilir miyim?</h3><p className="text-gray-400 text-xs leading-relaxed">Evet, video dosyalarını (MP4, MOV vb.) sisteme yükleyebilirsiniz. Ancak sistem videoları parça parça kesip video olarak vermez. Videonun o anki karesini <strong>yüksek kaliteli bir fotoğraf</strong> olarak yakalar ve bunu parçalara ayırır.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><Lock size={14} className="text-green-400" /> Fotoğraflarım güvende mi?</h3><p className="text-gray-400 text-xs leading-relaxed">Kesinlikle. Sitemiz "Client-Side" (İstemci Taraflı) çalışır. Yüklediğiniz dosyalar sunucuya gönderilmez, sadece tarayıcınızın geçici hafızasında (RAM) işlenir. Sayfayı kapattığınız an her şey silinir.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><Monitor size={14} className="text-purple-400" /> Hangi cihazlarda çalışır?</h3><p className="text-gray-400 text-xs leading-relaxed">Dump Splitter; iPhone, Android, Tablet ve Bilgisayar (PC/Mac) tarayıcılarında sorunsuz çalışır. Herhangi bir uygulama indirmenize gerek yoktur.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><Check size={14} className="text-blue-400" /> Ücretli mi, Sınır var mı?</h3><p className="text-gray-400 text-xs leading-relaxed">Tamamen ücretsizdir. Üyelik veya kredi sistemi yoktur. Performansın düşmemesi için aynı anda en fazla 20 dosya yükleyebilirsiniz ancak işlem bitince listeyi temizleyip tekrar yükleyebilirsiniz.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><ImageIcon size={14} className="text-pink-400" /> Hangi formatlar destekleniyor?</h3><p className="text-gray-400 text-xs leading-relaxed">Giriş olarak JPG, PNG, WEBP, HEIC (tarayıcı desteğine göre) ve popüler video formatlarını kabul eder. Çıktı olarak PNG, JPG veya WEBP formatında indirebilirsiniz.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><Download size={14} className="text-orange-400" /> İndirme çalışmıyor?</h3><p className="text-gray-400 text-xs leading-relaxed">Eğer indirme başlamazsa tarayıcınızın "Pop-up engelleyicisini" kontrol edin veya sayfayı yenileyip (F5) tekrar deneyin. Tek tek indirmek için parçanın üzerindeki ok işaretine basmanız yeterlidir.</p></div>

          {/* YENİ EKLENEN SORULAR */}
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><Sparkles size={14} className="text-fuchsia-400" /> AI Enhance renkleri bozar mı?</h3><p className="text-gray-400 text-xs leading-relaxed">Hayır, yapay zeka fotoğrafın doğal yapısını bozmadan sadece soluk renkleri, kontrastı ve doygunluğu optimize eder. Aşırı filtreli bir görünüm yerine profesyonel ve canlı bir sonuç verir.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><DownloadCloud size={14} className="text-sky-400" /> Uygulamayı İndirebilir miyim?</h3><p className="text-gray-400 text-xs leading-relaxed">Evet! Dump Splitter bir PWA (Progressive Web App) uygulamasıdır. Hem telefonunuza hem de bilgisayarınıza kurabilirsiniz.<br /><br /><strong>Telefonda:</strong> Tarayıcı menüsünden (Safari'de "Paylaş" &rarr; "Ana Ekrana Ekle", Chrome'da "Uygulamayı Yükle") diyerek.<br /><strong>Bilgisayarda:</strong> Chrome adres çubuğundaki yükle simgesine tıklayarak masaüstü uygulaması gibi kurabilirsiniz.</p></div>
          ...
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><Scale size={14} className="text-gray-300" /> HİÇBİR AYAR SEÇMEZSEM KALİTE DÜŞER Mİ?</h3><p className="text-gray-400 text-xs leading-relaxed">Asla. Varsayılan mod, fotoğrafınızı "Dengeli ve Sağlıklı" bir kalitede (%95) ve orijinal çözünürlüğünde işler. Fotoğrafınız bozulmaz veya pikselleşmez. Ekstra ayarlar (HD, AI vb.) sadece özel iyileştirmeler içindir.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><MousePointerClick size={14} className="text-stone-400" /> TEKLİ VEYA TOPLU İNDİRME ARASINDA KALİTE FARKI VAR MI?</h3><p className="text-gray-400 text-xs leading-relaxed">Hayır, hiçbir fark yoktur. İster tek tek indirin, ister 'Tümünü İndir' butonunu kullanın; sistem aynı işlem motorunu kullanır. Kalite, çözünürlük veya renklerde asla bir kayıp yaşanmaz.</p></div>
          ...
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><Grid size={14} className="text-violet-400" /> PARÇA SAYISI (3, 4, 6, 9) NEDEN FARKLI BÖLÜNÜYOR?</h3><p className="text-gray-400 text-xs leading-relaxed"><strong>Çift Sayılar (2, 4, 6, 8, 10):</strong> Sistem bunları genellikle 'Izgara' (Grid) veya 'Eşit Bölme' mantığıyla işler (Örn: 4 parça 2x2, 6 parça 2x3 grid olabilir veya dikeyde 2 sıra olabilir). Bu, özellikle dikey fotoğraflarda kenarlarda boşluk oluşmasına neden olabilir.<br /><strong>Tek Sayılar (3, 5, 7, 9):</strong> Bu sayılar genellikle tek bir sütun halinde (alt alta) bölünür. Bu yapı, fotoğrafın orijinal en/boy oranını bozmadan ekranı tam doldurmasını sağlar ve kenarlarda boşluk kalmaz.</p></div>
          <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 break-inside-avoid mb-6"><h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2"><FileImage size={14} className="text-yellow-500" /> HANGİ FORMATI (JPG, PNG, WEBP) SEÇMELİYİM?</h3><p className="text-gray-400 text-xs leading-relaxed"><strong>JPG:</strong> En yaygın format. Paylaşım için ideal ve dengelidir.<br /><strong>PNG:</strong> Kayıpsız kalitedir. Keskinlik çok önemlidir ama dosya boyutu yüksek olabilir.<br /><strong>WEBP:</strong> Hem yüksek kalite hem de düşük boyut sunan yeni nesil formattır. Instagram destekler.</p></div>
